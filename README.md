# Automation Testing Project – Selenium & TestNG
...
- **Wait Strategies** – Implementing implicit, explicit, and page load waits.
- **Element Locators** – Using XPath and CSS selectors to identify dynamic elements.
- **Mouse & Keyboard Actions** – Simulating user interactions with Robot and Actions classes.
...
- RobotClassExampleMouseOperations.java
- WindowHandlingExample.java
- DependsonTests.java
- ...and more
